...
PrimeList::PrimeList(int64_t max = 200000) {
    if (max > 1000000) {
...
// // code for verifying
// int main(void) {
//     PrimeList prime_list(64);
//     if (prime_list.IsPrime(3)) {
//         cout << "3 is prime" << endl;
//     } else {
//         cout << "3 is not prime";
//     }
//     if (prime_list.IsPrime(10)) {
//         cout << "10 is prime" << endl;
//     } else {
//         cout << "10 is not prime" << endl;
//     }
//     for (int i = 0; i < prime_list.GetSize(); i++) {
